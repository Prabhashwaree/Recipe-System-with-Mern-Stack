...
import { useAddIngredientMutation } from "../../features/ingredient/ingredientApiSlice";

const AddIngredients = () => {
  useTitle("Recipen - Add Ingredients");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const ingredient = await toast.promise(
        addIngredient({ ...formDetails }).unwrap(),
        {
          pending: "Please wait...",
  ...
  return (
    <section className="box flex flex-col gap-6">
      <h2 className="font-bold text-xl">Add New Ingredients</h2>
      <hr />
      <form
